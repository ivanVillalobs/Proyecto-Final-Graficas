...
public class Panel extends JPanel implements Runnable {
    ...
    public void paintComponent(Graphics g) {
        ...
        //Diseño calamardo----------------------------------------------------------------------
        drawLimb(new Point3D(centerPosition.x + 10, centerPosition.y + 10 - 200, centerPosition.z),
                new Point3D(centerPosition.x + 5, centerPosition.y + 50 - 200, centerPosition.z));
        drawLimb(new Point3D(centerPosition.x + 5, centerPosition.y + 50 - 200, centerPosition.z),
                new Point3D(centerPosition.x + 10, centerPosition.y + 90 - 200, centerPosition.z));
        //Pierna Derecha
        drawLimb(new Point3D(centerPosition.x - 10, centerPosition.y + 110 - 200, centerPosition.z),
                new Point3D(centerPosition.x - 20, centerPosition.y + 150 - 200, centerPosition.z));
        drawLimb(new Point3D(centerPosition.x - 20, centerPosition.y + 150 - 200, centerPosition.z),
                new Point3D(centerPosition.x - 50, centerPosition.y + 190 - 200, centerPosition.z));

        drawCylinder();
        drawSphere();
        drawFace();
        //Brazo Izquierdo
        drawLimb(new Point3D(centerPosition.x - 30, centerPosition.y + 10 - 200, centerPosition.z),
                new Point3D(centerPosition.x - 35, centerPosition.y + 50 - 200, centerPosition.z));
        drawLimb(new Point3D(centerPosition.x - 35, centerPosition.y + 50 - 200, centerPosition.z),
                new Point3D(centerPosition.x - 30, centerPosition.y + 90 - 200, centerPosition.z));
        // Pierna Izquierda
        drawLimb(new Point3D(centerPosition.x - 10, centerPosition.y + 110 - 200, centerPosition.z),
                new Point3D(centerPosition.x + 10, centerPosition.y + 150 - 200, centerPosition.z));
        drawLimb(new Point3D(centerPosition.x + 10, centerPosition.y + 150 - 200, centerPosition.z),
                new Point3D(centerPosition.x + 10, centerPosition.y + 190 - 200, centerPosition.z));
